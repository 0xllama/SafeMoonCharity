...
/**
   ...
   Requirement - 2.5% go to Liquidity, 2.5% go to a special Charity of my choice & 5% to owners. 
...
contract SafeMoonCharity is Context, IERC20, Ownable {
    ...
    string private _name = "SafeMoonCharity";
    string private _symbol = "SafeMoonCharity";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 5;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _charityFee = 2.5;
